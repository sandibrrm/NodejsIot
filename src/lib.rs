...
#[derive(Debug)]
pub struct NodejsIotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodejsIotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodejsIot processing");
    
    let mut processor = NodejsIotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodejsIotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodejsIotProcessor::new(false);
